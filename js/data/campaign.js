...
export const CAMPAIGN = [
  ...
  },
  {
    ...
    difficulty: 'normal', boss: { startArmor: 3 },
    intro: 'БОСС. Живая гора в Боевом Доспехе. Начинает бой с 3 брони.',
    rewardGold: 300,
    unlocks: ['igg_hammer', 'torq', 'rotting_golem'],
    addCards: ['tolya_grohot'],
  },
  {
    id: 'c6', name: 'Ледяная Заводь', icon: '🧊', class: 'azimandia',
    difficulty: 'normal', deckMod: 'weak', boss: { openingBoard: ['iceShard', 'iceShard'] },
    intro: 'БОСС. Хозяйка заводи начинает бой с ледяными осколками на столе и морозит всё живое.',
    addCards: ['star_ice', 'star_ice'],
    rewardGold: 350,
  ...
  },
  {
    ...
    difficulty: 'hard', boss: { startArmor: 8, extraHealth: 5 },
    intro: 'БОСС. 35 здоровья и 8 брони. Его клинки не знают промаха.',
    rewardGold: 450,
    unlocks: ['executioner_blades', 'night_terror', 'will_empress'],
    addCards: ['executioner_blades', 'night_terror', 'imago_executioner', 'imago_executioner'],
  },
  {
